...
public class Util_Http_Command_Function {
    ...
    public static int Register(String admin,String password,String SerialNum,String companyname,String firstname,String lastname,String phone,String State,String country,String city,String streat,String zp){
        try{
            StringBuffer sb = new StringBuffer();
            sb.append("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                    "<soap12:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap12=\"http://www.w3.org/2003/05/soap-envelope\">\n" +
